...
from gui.rain_left_panel import RainLeftPanel
...
class RainSimulationWindow(QMainWindow):
    def __init__(self):
        super().__init__()
        ...
        self.initUI()
        try:
            self.setWindowIcon(QIcon('resources/icons/rain_cloud.png'))
        except:
            pass

    def initUI(self):
        self.setWindowTitle('降雨环境下大气散射特性建模仿真')
